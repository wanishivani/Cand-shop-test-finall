          ...
          <>
            <Nav>
              <Nav.Link to="/store" as={NavLink}>
                <h1
                  className="d-flex flex-column bd-highlight mb-50 mw-100  text-white me-auto display-1"
                  style={{
                    textAlign: "left",
                    padding: "",
                    margin: "",
            ...
            <Nav>
              <Nav.Link to="/contact " as={NavLink}>
                <h1
                  className="d-flex flex-column bd-highlight mb-50 mw-100  me-auto text-dark display-1"
                  style={{
                    textAlign: "left",
                    padding: "",
                    margin: "",
            ...
            <li
              style={{ backgroundColor: "", textAlign: "justify", margin: "" ,width:''}}
            >
              <Button 
                onClick={() =>
                  logout({
